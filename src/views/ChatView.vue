...
<template>
  <div class="chat-layout">
    <div class="group">
      ...
      <template v-else>
        <SidebarChatItem v-for="chat in filteredChats" :key="chat.groupId" :groupId="chat.groupId"
          :groupName="chat.groupName" :lastMessage="chat.lastMessage" :groupBackground="chat.groupBackground"
          :lastActive="chat.lastActive" :messageUnreadCount="chat.messageUnreadCount" :online="chat.online"
          @click="selectChat(chat.groupId)" />
      </template>
      <div class="create-group-button" @click="showCreateGroupDialog = true; fetchUsers()">
    ...
    <div v-if="showCreateGroupDialog" class="create-group-dialog">
      ...
      <div class="member-list">
        <div v-for="user in filteredUsers" :key="user.id" @click="toggleMember(user.id)"
